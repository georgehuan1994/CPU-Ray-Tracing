...
int main()
{
    ...
    const int samples_per_pixel = 500; // 样本数，从每个像素发出的射线数 500
    ...
    FILE* f = fopen("image.ppm", "w");  // 没有用 CMake 和 string，直接用的 MSBuild，改为文件 IO，添加 C/C++ 预处理器定义 _CRT_SECURE_NO_WARNINGS
